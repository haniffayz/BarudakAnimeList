    ...
    return (
        <>
            {isCreated 
                ...
                2xl:h-16 lg:w-40 xl:w-44 xl:h-12 w-full h-12 rounded-xl hover:bg-colos-SidebarAccent hover:text-colos-accent animation">
                ...
                <button
                    ...
                    className="md:py-0 xl:mt-2 md:mt-4 my-4 md:my-0 bg-color-accent border dark:border-colos-accent border-colos-primary 2xl:w-52 2xl:h-16 lg:w-40 xl:w-44 xl:h-12 w-full h-12 rounded-xl hover:bg-colos-SidebarAccent hover:text-colos-accent animation">
                        <div className='flex items-center justify-center text-center md:p-2 xl:p-0 gap-2'>
